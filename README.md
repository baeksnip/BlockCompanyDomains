...
With this information, rules can be defined in a firewall, pihole or any other tool that allows access control to devices on a network with the Internet.
